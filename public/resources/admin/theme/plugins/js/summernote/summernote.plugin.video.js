(function (factory) {
   ...
   * @return {Node}
   */
  var createVideoNode = function (url, poster) {
      ...
      $videoDialog.one('shown.bs.modal', function () {
        ...
        $videoBtn.click(function (event) {
          event.preventDefault();
           ...
           if($jbkResults["video"] !== undefined ){
               deferred.resolve($jbkResults);
           }else{
         ...
         $('.jbkfilemanager.poster').jassets({
                            success: function(result, id){
                                $jbkResults['poster'] = result.src;
                                if( $jbkResults['video'] !== undefined){
          ...
          $('.jbkfilemanager.video').jassets({
                            success: function(result, id){
                                $jbkResults['video'] = result.src;
                                if( $jbkResults['poster'] !== undefined){
                                    toggleBtn($videoBtn, true);
                                }
                            }
                        });
    ...
    dialogs: {
      video: function (lang) {
        var body = '<div class="form-group row-fluid">' +
                 '<a class="btn btn-primary jbkfilemanager video" data-type="video">Video</a> ' +
                 '<a class="btn btn-primary jbkfilemanager poster" data-type="poster">Poster</a> <br /><br />' +
    ...
    events: {
      showVideoDialog: function (event, editor, layoutInfo) {
        ...
        showVideoDialog($editable, $dialog, text).then(function (url) {
          ...
          if(url["video"] !== undefined ){
            var poster = url["poster"];
            var url = url["video"];
          }
          // restore range
          ...
          // build node
          var $node = createVideoNode(url, poster);
