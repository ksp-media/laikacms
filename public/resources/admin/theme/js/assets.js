...
Jbkcms.Assets = {
    ...
    initEditableContent: function () {
        $('.edit-attribute').each(function () {
            ...
            $(this).on('change', function () {
                $.post('/' + jbkcms_prefix + '/assets/folder/update', {'id': $(this).attr('data-id'), 'attribute': $(this).attr('data-attribute'), 'value': $(this).html()}, function () {
                    console.log('updated')
                })
            });
        });
    ...
    initUploadButton: function () {
        $('.btn-upload').dropzone({
            url: "/" + jbkcms_prefix + "/assets/upload/" + Jbkcms.Assets.currentFolderId,
            paramName: "file",
...
Jbkcms.AssetManager = {
    ...
    loadModal: function () {
        $.get('/' + jbkcms_prefix + '/assets/manager', function (response) {
