...
class CmsController extends BaseController {
    ...
    public function savePageAction(){
        if (key_exists('id', $_POST['page'])) {
            ...
            return \Redirect::to("/"._JBKCMS_PREFIX_."/cms/pages")->with('message', 'page not found!');
        }
        if($page){
            $data = $_POST['page'];
            if(!$data['slug']){
            ...
            $page->update($data);
            return \Redirect::to("/"._JBKCMS_PREFIX_."/cms/page/{$page->id}/edit")->with('message', 'Page succesfully updated now');
        }else{
            return \Redirect::to("/"._JBKCMS_PREFIX_."/cms/pages")->with('message', 'page not found!');
        }
