...
class EditableText extends Tag implements TagInterface{
    
    protected $_pattern =  '/@editable_text\(\'(.*?)\'\)(.*?)@endeditable_text/is';
    ...
    public function handleResult(){
        ...
        foreach ($this->_results as $r) {
            ...
            $this->addTmplObj(array('origin' => $r[0], 'key' => $r[1], 'value' => $c, 'type' => 'textarea'));
        }
    }
