...
namespace Juboka\Jbkcms;

use Illuminate\Support\ServiceProvider;

define ('_LCMS_PREFIX_', (config('lcms.default.uri-prefix'))?config('lcms.default.uri-prefix'):'lcms');
...
class LCMSNextServiceProvider extends ServiceProvider {
    ...
    public function boot() {
        ...
        $this->loadViewsFrom(__DIR__ . '/../../views', 'lcms');
        $this->publishes([
            __DIR__ . '/../../../public' => public_path('packages/kspm/lcms'),
                ], 'public');
