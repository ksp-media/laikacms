            ...
            <nav class="navbar-default navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li @if($current_module == "assets") class="active" @endif><a href="/{{$cmsprefix}}/assets/folder/1" title="Dateien"><i class="fa fa-user"></i><span class="nav-label">Dateimanager</span></a></li>
                        @endif
